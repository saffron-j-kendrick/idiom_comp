...
def mlp_attention_masking():
    ...
    rep_type = f"final_standard_attention_head_masked_168_mlp_masked_168"
...
def random_mlp_attention_masking():
    ...
    for run_idx in range(num_random_runs):
        ...
        rep_type = f"final_standard_attention_head_masked_168_mlp_masked_168_random_run{run_idx + 1}"
